...
import {adminLogin} from './frontend/views/adminLogin';
import {adminRegistration} from './frontend/views/adminRegistration';
import {cultureEdit} from './frontend/views/cultureEdit';
import {cultureInsights} from './frontend/views/cultureInsights';
import {editInsight} from './frontend/views/editInsight';
